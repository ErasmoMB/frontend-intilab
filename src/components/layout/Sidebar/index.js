...
const Sidebar = memo(({ setChartType, isOpen, isCollapsed, setIsOpen }) => {
  const handleChartTypeChange = useCallback(
    (type) => {
      setChartType(type);
      setIsOpen(false);
    },
    [setChartType, setIsOpen]
  );
  ...
  return (
    <>
      ...
      />
      <aside className={`dashboard-sidebar ${isOpen || isCollapsed ? "open" : ""} ${isCollapsed ? "collapsed" : ""}`}>
